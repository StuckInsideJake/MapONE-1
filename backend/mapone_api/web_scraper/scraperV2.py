...
from mapone_api.web_scraper.util_functions import pre_processing, argument_formatter, keyword_url_generator, abstract_id_log_name_generator, status_logger

# import entry class
from mapone_api.entry import EntryClass

keywords_to_search = "Titan atmosphere"
